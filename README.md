# Introduction
The goal of this project is to make dynamic library usage easy for Python developers. If a requirements.txt file is present in the
root directory of the project, then they will automatically be used when running the specified script.


# Getting Started
To execute a Python script, run 'depy <script name>'. This will install any dependencies listed in requirements.txt, presuming they aren't
already installed on their system, and then execute the script.
